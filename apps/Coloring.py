...
print(f"""{LCY}
╔═════════╗
║Caps Lock║{WHI}     или 'пиши' пишет русский голос{LCY}
╚═════════╝     
╔════════╗      
║Num Lock║{WHI}      или 'инглиш' пишет английский голос{LCY}
╚════════╝      
╔═════════╗ ╔════════╗    
║Caps Lock║ ║Num Lock║{WHI} или 'переводчик' пишет переведённый на английский голос{LCY}
╚═════════╝ ╚════════╝{LGR}    
┌────┬───┬───┐            {LCY}╔═════════╗ ╔════════╗{LGR}
│Ctrl│   │Alt│{WHI}  выключает {LCY}║Caps Lock║ ║Num Lock║{LGR}
└────┴───┴───┘            {LCY}╚═════════╝ ╚════════╝{LGR}   
┌────┬───┐       
│Ctrl│Win│{WHI}      или 'пауза' - режим паузы{LGR}
└────┴───┘      
┌─────┐        
│Shift│       
└────┬┴──┬───┐{WHI}  или 'действие' - G4f_action{LGR}    
     │Win│Alt│
     └───┴───┘   
┌─────┐        
│Shift│       
├────┬┘         {WHI}изображение в текст{LGR}
│Ctrl│
└────┘    
{WHI}""", sep='', end='')
